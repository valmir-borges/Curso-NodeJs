...
const server = http.createServer((req, res)=>{//Será criado um servidor com os parâmetros de requisição e a resposta, pois é a partir dela que uma decisão sera tomada
    res.write('Salve dog')//Será enviado um texto para quem acessar localhost:3000, este texto é a resposta do servidor dada diante a requisição de acessar a página
    res.end()//Finaliza ela para que não seja infinita
})
