...
const server = http.createServer((req, res)=>{
    ...
    const name = urlinfo.query.name//Está sendo pegado da urlinfo somente o nome, que virá do arquivo html
            ...
            const nameporlinha = name + '\r\n'// Está pegando o name da url e colocando nessa const, o /r/n serve para dar uma quebra de linha no arquivo txt
            fs.appendFile('arquivo.txt', nameporlinha, function(err, data){//O modulo fs irá criar um arquivo chamado texto.txt, com o name dentro e retornando uma função
